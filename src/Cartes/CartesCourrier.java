...
public class CartesCourrier{
	...
	public static String[][] recupererCartesCourrier() {            
		...
		cartes [0]=creerCarteCourrier("1 lettre de vos grand-parents","Salut mon petit loup , nous t'invitons papito et moi à venir passer les fêtes à la maison." );     // Lettre RolePlay
		...
		cartes [7]=creerCarteCourrier("1 Rendez-vous chez le medecin","Vous etes atteins du Covid-67, vous devez payer 200euros de frais médicaux." );    // payer 200 de Frais m�dicaux                 
		cartes [8]=creerCarteCourrier("1 Constat d'accident","Vous avez roulé sur un caillou un peu gros, payer 200euros de frais de réparation " );    // payer 200 de Frais de r�paration
		...
		cartes [10]=creerCarteCourrier("1 Concours de beauté", " Vous avez été repéré par les dirigeants du concours et vous y êtes invité");            // lettre RolePlay                
		...
		cartes [14]=creerCarteCourrier("1 Rendez-vous chez le medecin","Vous avez un m�chant rhume et vous devez payer 200 euros de frais médicaux" );    // payer 200 de frais m�dicaux
		...
		cartes [16]=creerCarteCourrier("1 Amende","vous avez été flashé a plus de 20 KM/H au dessus de la limitation de vitesse, -2 points sur le permis et 200euros a payer à la banque." ); // payer 200
		cartes [17]=creerCarteCourrier("1 Constat d'accident","Vous devez payer 200 euros de réparation pour votre nouvelle trotinette" );                 // payer 200 de frais de r�paration
		cartes [18]=creerCarteCourrier("1 Constat d'accident","Vous vous avez décidé de drifter comme dans un film et devez changer vos pneus, payer 200 euros de frais de réparation" ); // payer 200 de frais de r�paration
		cartes [19]=creerCarteCourrier("1 Rendez vous chez le m�decin","Vous vous êtes foulé la cheville en jonglant, payer 200 de frais médicaux" );    // payer 200 de frais m�dicaux
		return cartes;
	}
