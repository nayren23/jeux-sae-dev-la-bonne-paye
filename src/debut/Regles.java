...
public class Regles {
	...
	public static void regles (Scanner saisie) {
		...
		System.out.println("										___________________________________					\r\n"
				...
				+ "		-A son tour de jeu, chaque joueur lance le dé et avance du nombre de cases correspondant au chiffre indiqué par le dé. \r\n"
				...
				+ "		-En revanche, si au cours du mois, il fait un retrait quelconque, il doit verser immédiatement 100 euros  à la Banque, quel que soit le montant de son retrait.\r\n"
				+ "\r\n"
				+ "		2/LES PRETS : Les emprunts se font également à la Banque. Le montant d’un prêt est  de 1000 euros. \r\n"
				+ "		-----------\r\n"
				+ "		-Le banquier donne l’argent à l’emprunteur avec une carte de PRÊT qui sert de contrôle permanent.\r\n"
				+ "\r\n"
				+ "		-A la fin du mois, l’emprunteur paye les intérêts qui sont dus à la Banque.Les sommes empruntées peuvent être conservées par l’emprunteur sans les rembourser \r\n"
				+ "		à la Banque pendant le mois durant lequel l’emprunt a été contracté et durant les 2 mois suivants.\r\n"
				+ "		-Mais le joueur endetté doit obligatoirement rembourser son emprunt le 31 du deuxième mois, sans recourir évidemment à un autre emprunt à la Banque à ce moment-là !\r\n"
				+ "\r\n"
