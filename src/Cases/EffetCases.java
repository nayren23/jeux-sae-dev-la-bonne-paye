...
public class EffetCases {
	...
	public static void case1Courrier/*case1*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Courrier piochez en 1 :) !!");
	...
	public static void caseConcoursBeaute/*case2*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Concours de Beaute !!");
	...
	public static void case3Courrier/*case3*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Courrier piochez en 3 :) !!");
		CartesCourrier.effetCartesCourrier();
		CartesCourrier.effetCartesCourrier();
		CartesCourrier.effetCartesCourrier();
		DonneesPartagees.choixDuJoueur("Appuyer sur 1 pour laisser le prochain joueur jouer  !!  ");
	...
	public static void caseAcquisition/*case4...*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Acquisition  !!");
		CartesAcquisition.effetCartesAcquisitions();
	}

	public static void case2Courrier/*case5*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Courrier piochez en 2 :) !!");
		CartesCourrier.effetCartesCourrier();
		CartesCourrier.effetCartesCourrier();
		DonneesPartagees.choixDuJoueur("Appuyer sur 1 pour laisser le prochain joueur jouer  !!  ");
	}
	...
	public static void caseFamille/*case6*/ () {
		...
		System.out.println("Ho non " +DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes tombé sur la case sortie en famille payer 150 euros dans la cagnotte !!");
	...
	public static void caseCaisseElectoral/*case8*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Caisse Electoral c'est l'heure des elections  !!");
		System.out.println("Ho non tout le monde verse 150 euros à la cagnotte !!");
		DonneesPartagees.choixDuJoueur("Appuyer sur 1 pour que tout le monde paye  !!  ");
	...
	public static void caseBricolage/*case15*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Bricolage  !!");
	...
	public static void caseShopping/*case19*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Shopping  !!");
		System.out.println("Journee shopping pour  " +DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" depensez  250 euros dans la cagnotte !!");
		DonneesPartagees.choixDuJoueur("Appuyer sur 1 pour payer  !!  ");
	...
	public static void caseChangementDheure/*case26*/ () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Changement d'heure  !!");
	...
	public static void caseJourDePaye/*case31*/ () {
		...
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Jour de paye  !!");
	...
	public static void caseVendez () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case Vendez  !!");
		CaseVendre.vendre();
	}


	public static void caseQuoiDeNeuf () {
		System.out.println(DonneesPartagees.tabNomJoueur[DonneesPartagees.indexeJoueurCourant]+" vous êtes sur la case QuoiDeNeuf  !!");
